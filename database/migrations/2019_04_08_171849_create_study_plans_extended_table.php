...
class CreateStudyPlansExtendedTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('study_plans_extended', function (Blueprint $table) {
            ...
            $table->string('evaluation_type_sem7')->nullable();
            $table->integer('credits_sem8')->nullable();
            $table->string('evaluation_type_sem8')->nullable();
    ...
    {
        Schema::dropIfExists('study_plans_extended');
    }
}
