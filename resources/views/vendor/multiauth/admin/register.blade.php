        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Užregistruoti naują administratorių
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Vardas ir pavardė</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Patvirtinti slaptažodį</label>
