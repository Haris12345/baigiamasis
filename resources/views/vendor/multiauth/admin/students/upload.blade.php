            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span class="float-right">
                            <a href="{{route('admin.students.download')}}" class="btn btn-primary">Studentų šablonas</a>
                        </span>
                        <br/>
                        <h3>Studentų įkėlimas iš Excel failo</h3>
                        <form method="post" action="{{route('admin.students.import')}}" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group row">
                                <label for="import" class="col-md-4 col-form-label text-md-right">{{ __('Studentai') }}</label>
